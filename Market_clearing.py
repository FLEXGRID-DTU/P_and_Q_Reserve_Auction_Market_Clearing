...
def Market_clearing(Bid, Setpoint_P, Setpoint_Q, orderbook_request, orderbook_offer, accepted_requests, accepted_offers,  nodes, NetworkData, SocialWelfare, ProcurementCost):
    ...
    for o in model.R_P:
        ...
        if (req_rem > 0):
            new=requests_P.loc[o,['Bus','Type','P_or_Q','Direction','Quantity','Price','Time_target','Time_stamp']]
    ...
    for o in model.O_P:
        ...
        if (off_rem > 0):
            new=offers_P.loc[o,['Bus','P_or_Q','Direction','Quantity','Price','Time_target','Time_stamp']]
    ...
    for o in model.O_Q:
        ...
        if (off_rem > 0):
            new=offers_Q.loc[o,['Bus','P_or_Q','Direction','Quantity','Price','Time_target','Time_stamp']]
            new['Quantity']=off_rem
            orderbook_offer= orderbook_offer.append(new) 
    ...
    return orderbook_request, orderbook_offer, accepted_requests, accepted_offers, SocialWelfare, ProcurementCost