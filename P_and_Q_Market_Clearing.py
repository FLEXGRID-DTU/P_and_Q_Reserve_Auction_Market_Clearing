...
for t in Setpoint_P.index:
    ...
    match_t, orderbook_request, orderbook_offer, accepted_requests, accepted_offers, SocialWelfare, ProcurementCost = Market_clearing(Bid_t, Setpoint_P.at[t,'Setpoint_P'], Setpoint_Q.at[t,'Setpoint_Q'] , orderbook_request, orderbook_offer, accepted_requests, accepted_offers, nodes, NetworkData, SocialWelfare, ProcurementCost)    
    matches=matches.append(match_t)        
